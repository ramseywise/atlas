"""Shared report theme — CSS and header/footer helpers for atlas eval reports."""
...
def report_footer_note(text: str = "Generated by the atlas eval report builder") -> str:
