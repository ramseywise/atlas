...
**Then immediately load `.agents/skills/adk-dev-guide/SKILL.md`** — it contains the development workflow, coding guidelines, and operational rules you must follow when implementing the agent.
